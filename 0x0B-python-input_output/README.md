...
This project, focuses on file handling in Python. The builtin `with`, `open`, and `read` functions was used with the `json` module to read and write files and serialize and deserialize objects with JSON.
